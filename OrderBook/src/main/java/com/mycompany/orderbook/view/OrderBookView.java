 ...
 */
package com.mycompany.orderbook.view;
...
public class OrderBookView {
    ...
    public void DisplayTradeInfo(Trade trade) {
        io.print("Trade:" + trade.getUniqueiid());
        io.print("Price:" + trade.getUniqueiid());
...
//        stats.add(5, AverageSellPrice);
    ...
    public void DisplayTradesByExecutionTime(List<Trade> SortedTradeList) {
        for (Trade trade : SortedTradeList) {
            io.print("Trade ID:" + trade.getUniqueiid());
            io.print("Trade Price:" + trade.getExecutionPrice());
